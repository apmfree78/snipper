pub use uniswap_v3_factory_base::*;
...
pub mod uniswap_v3_factory_base {
    const _: () = {
        ::core::include_bytes!(
            "/Users/apmfree/Desktop/rust/learn_ethers/examples/abi/uniswap_factory_base.json",
        );
    };
    #[allow(deprecated)]
    ...
    pub static UNISWAP_V3_FACTORY_BASE_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct UNISWAP_V3_FACTORY_BASE<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for UNISWAP_V3_FACTORY_BASE<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for UNISWAP_V3_FACTORY_BASE<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for UNISWAP_V3_FACTORY_BASE<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for UNISWAP_V3_FACTORY_BASE<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(UNISWAP_V3_FACTORY_BASE))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> UNISWAP_V3_FACTORY_BASE<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    UNISWAP_V3_FACTORY_BASE_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            UNISWAP_V3_FACTORY_BASEEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for UNISWAP_V3_FACTORY_BASE<M> {
    ...
    pub enum UNISWAP_V3_FACTORY_BASEEvents {
        FeeAmountEnabledFilter(FeeAmountEnabledFilter),
        OwnerChangedFilter(OwnerChangedFilter),
        PoolCreatedFilter(PoolCreatedFilter),
    }
    impl ::ethers::contract::EthLogDecode for UNISWAP_V3_FACTORY_BASEEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = FeeAmountEnabledFilter::decode_log(log) {
                return Ok(
                    UNISWAP_V3_FACTORY_BASEEvents::FeeAmountEnabledFilter(decoded),
                );
            }
            if let Ok(decoded) = OwnerChangedFilter::decode_log(log) {
                return Ok(UNISWAP_V3_FACTORY_BASEEvents::OwnerChangedFilter(decoded));
            }
            if let Ok(decoded) = PoolCreatedFilter::decode_log(log) {
                return Ok(UNISWAP_V3_FACTORY_BASEEvents::PoolCreatedFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for UNISWAP_V3_FACTORY_BASEEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<FeeAmountEnabledFilter>
    for UNISWAP_V3_FACTORY_BASEEvents {
        fn from(value: FeeAmountEnabledFilter) -> Self {
            Self::FeeAmountEnabledFilter(value)
        }
    }
    impl ::core::convert::From<OwnerChangedFilter> for UNISWAP_V3_FACTORY_BASEEvents {
        fn from(value: OwnerChangedFilter) -> Self {
            Self::OwnerChangedFilter(value)
        }
    }
    impl ::core::convert::From<PoolCreatedFilter> for UNISWAP_V3_FACTORY_BASEEvents {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum UNISWAP_V3_FACTORY_BASECalls {
    ...
    impl ::ethers::core::abi::AbiDecode for UNISWAP_V3_FACTORY_BASECalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for UNISWAP_V3_FACTORY_BASECalls {
    ...
    impl ::core::fmt::Display for UNISWAP_V3_FACTORY_BASECalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<CreatePoolCall> for UNISWAP_V3_FACTORY_BASECalls {
        fn from(value: CreatePoolCall) -> Self {
            Self::CreatePool(value)
        }
    }
    impl ::core::convert::From<EnableFeeAmountCall> for UNISWAP_V3_FACTORY_BASECalls {
        fn from(value: EnableFeeAmountCall) -> Self {
            Self::EnableFeeAmount(value)
        }
    }
    impl ::core::convert::From<FeeAmountTickSpacingCall>
    for UNISWAP_V3_FACTORY_BASECalls {
        fn from(value: FeeAmountTickSpacingCall) -> Self {
            Self::FeeAmountTickSpacing(value)
        }
    }
    impl ::core::convert::From<GetPoolCall> for UNISWAP_V3_FACTORY_BASECalls {
        fn from(value: GetPoolCall) -> Self {
            Self::GetPool(value)
        }
    }
    impl ::core::convert::From<OwnerCall> for UNISWAP_V3_FACTORY_BASECalls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<ParametersCall> for UNISWAP_V3_FACTORY_BASECalls {
        fn from(value: ParametersCall) -> Self {
            Self::Parameters(value)
        }
    }
    impl ::core::convert::From<SetOwnerCall> for UNISWAP_V3_FACTORY_BASECalls {
