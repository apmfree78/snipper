...
pub mod uniswap_pair {
    const _: () = {
        ::core::include_bytes!(
            "/Users/apmfree/Desktop/rust/learn_ethers/examples/abi/uniswap_pair.json",
        );
    };
    #[allow(deprecated)]
    ...
    pub static UNISWAP_PAIR_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct UNISWAP_PAIR<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for UNISWAP_PAIR<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for UNISWAP_PAIR<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for UNISWAP_PAIR<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for UNISWAP_PAIR<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(UNISWAP_PAIR))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> UNISWAP_PAIR<M> {
    ...
    impl ::ethers::contract::EthLogDecode for UNISWAP_PAIREvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = ApprovalFilter::decode_log(log) {
                return Ok(UNISWAP_PAIREvents::ApprovalFilter(decoded));
            }
            if let Ok(decoded) = BurnFilter::decode_log(log) {
                return Ok(UNISWAP_PAIREvents::BurnFilter(decoded));
            }
            if let Ok(decoded) = MintFilter::decode_log(log) {
                return Ok(UNISWAP_PAIREvents::MintFilter(decoded));
            }
            if let Ok(decoded) = SwapFilter::decode_log(log) {
                return Ok(UNISWAP_PAIREvents::SwapFilter(decoded));
            }
            if let Ok(decoded) = SyncFilter::decode_log(log) {
                return Ok(UNISWAP_PAIREvents::SyncFilter(decoded));
            }
            if let Ok(decoded) = TransferFilter::decode_log(log) {
                return Ok(UNISWAP_PAIREvents::TransferFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for UNISWAP_PAIREvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ApprovalFilter> for UNISWAP_PAIREvents {
        fn from(value: ApprovalFilter) -> Self {
            Self::ApprovalFilter(value)
        }
    }
    impl ::core::convert::From<BurnFilter> for UNISWAP_PAIREvents {
        fn from(value: BurnFilter) -> Self {
            Self::BurnFilter(value)
        }
    }
    impl ::core::convert::From<MintFilter> for UNISWAP_PAIREvents {
        fn from(value: MintFilter) -> Self {
            Self::MintFilter(value)
        }
    }
    impl ::core::convert::From<SwapFilter> for UNISWAP_PAIREvents {
        fn from(value: SwapFilter) -> Self {
            Self::SwapFilter(value)
        }
    }
    impl ::core::convert::From<SyncFilter> for UNISWAP_PAIREvents {
        fn from(value: SyncFilter) -> Self {
            Self::SyncFilter(value)
        }
    }
    impl ::core::convert::From<TransferFilter> for UNISWAP_PAIREvents {
    ...
    impl ::ethers::core::abi::AbiDecode for UNISWAP_PAIRCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for UNISWAP_PAIRCalls {
    ...
    impl ::core::fmt::Display for UNISWAP_PAIRCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<DomainSeparatorCall> for UNISWAP_PAIRCalls {
        fn from(value: DomainSeparatorCall) -> Self {
            Self::DomainSeparator(value)
        }
    }
    impl ::core::convert::From<MinimumLiquidityCall> for UNISWAP_PAIRCalls {
        fn from(value: MinimumLiquidityCall) -> Self {
            Self::MinimumLiquidity(value)
        }
    }
    impl ::core::convert::From<PermitTypehashCall> for UNISWAP_PAIRCalls {
        fn from(value: PermitTypehashCall) -> Self {
            Self::PermitTypehash(value)
        }
    }
    impl ::core::convert::From<AllowanceCall> for UNISWAP_PAIRCalls {
        fn from(value: AllowanceCall) -> Self {
            Self::Allowance(value)
        }
    }
    impl ::core::convert::From<ApproveCall> for UNISWAP_PAIRCalls {
        fn from(value: ApproveCall) -> Self {
            Self::Approve(value)
        }
    }
    impl ::core::convert::From<BalanceOfCall> for UNISWAP_PAIRCalls {
        fn from(value: BalanceOfCall) -> Self {
            Self::BalanceOf(value)
        }
    }
    impl ::core::convert::From<BurnCall> for UNISWAP_PAIRCalls {
        fn from(value: BurnCall) -> Self {
            Self::Burn(value)
        }
    }
    impl ::core::convert::From<DecimalsCall> for UNISWAP_PAIRCalls {
        fn from(value: DecimalsCall) -> Self {
            Self::Decimals(value)
        }
    }
    impl ::core::convert::From<FactoryCall> for UNISWAP_PAIRCalls {
        fn from(value: FactoryCall) -> Self {
            Self::Factory(value)
        }
    }
    impl ::core::convert::From<GetReservesCall> for UNISWAP_PAIRCalls {
        fn from(value: GetReservesCall) -> Self {
            Self::GetReserves(value)
        }
    }
    impl ::core::convert::From<InitializeCall> for UNISWAP_PAIRCalls {
        fn from(value: InitializeCall) -> Self {
            Self::Initialize(value)
        }
    }
    impl ::core::convert::From<KlastCall> for UNISWAP_PAIRCalls {
        fn from(value: KlastCall) -> Self {
            Self::Klast(value)
        }
    }
    impl ::core::convert::From<MintCall> for UNISWAP_PAIRCalls {
        fn from(value: MintCall) -> Self {
            Self::Mint(value)
        }
    }
    impl ::core::convert::From<NameCall> for UNISWAP_PAIRCalls {
        fn from(value: NameCall) -> Self {
            Self::Name(value)
        }
    }
    impl ::core::convert::From<NoncesCall> for UNISWAP_PAIRCalls {
        fn from(value: NoncesCall) -> Self {
            Self::Nonces(value)
        }
    }
    impl ::core::convert::From<PermitCall> for UNISWAP_PAIRCalls {
        fn from(value: PermitCall) -> Self {
            Self::Permit(value)
        }
    }
    impl ::core::convert::From<Price0CumulativeLastCall> for UNISWAP_PAIRCalls {
        fn from(value: Price0CumulativeLastCall) -> Self {
            Self::Price0CumulativeLast(value)
        }
    }
    impl ::core::convert::From<Price1CumulativeLastCall> for UNISWAP_PAIRCalls {
        fn from(value: Price1CumulativeLastCall) -> Self {
            Self::Price1CumulativeLast(value)
        }
    }
    impl ::core::convert::From<SkimCall> for UNISWAP_PAIRCalls {
        fn from(value: SkimCall) -> Self {
            Self::Skim(value)
        }
    }
    impl ::core::convert::From<SwapCall> for UNISWAP_PAIRCalls {
        fn from(value: SwapCall) -> Self {
            Self::Swap(value)
        }
    }
    impl ::core::convert::From<SymbolCall> for UNISWAP_PAIRCalls {
        fn from(value: SymbolCall) -> Self {
            Self::Symbol(value)
        }
    }
    impl ::core::convert::From<SyncCall> for UNISWAP_PAIRCalls {
        fn from(value: SyncCall) -> Self {
            Self::Sync(value)
        }
    }
    impl ::core::convert::From<Token0Call> for UNISWAP_PAIRCalls {
        fn from(value: Token0Call) -> Self {
            Self::Token0(value)
        }
    }
    impl ::core::convert::From<Token1Call> for UNISWAP_PAIRCalls {
        fn from(value: Token1Call) -> Self {
            Self::Token1(value)
        }
    }
    impl ::core::convert::From<TotalSupplyCall> for UNISWAP_PAIRCalls {
        fn from(value: TotalSupplyCall) -> Self {
            Self::TotalSupply(value)
        }
    }
    impl ::core::convert::From<TransferCall> for UNISWAP_PAIRCalls {
        fn from(value: TransferCall) -> Self {
            Self::Transfer(value)
        }
    }
    impl ::core::convert::From<TransferFromCall> for UNISWAP_PAIRCalls {
