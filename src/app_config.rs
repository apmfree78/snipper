...
pub const CODE_CHECK_PROMPT: &str = r#"You are a expert Solidity security reviewer. I will provide you with an ERC‑21 contract source code. You need to check whether this contract has any signs of being a rug pull, honeypot, or other scam.
