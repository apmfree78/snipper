...
pub struct TokenHolderAnalysis {
    ...
    pub creator_has_more_than_threshold_percent: bool,
    pub top_holder_more_than_threshold_percent: bool,
}
...
pub async fn get_token_holder_analysis(
    ...
    let token_holder_analysis = TokenHolderAnalysis {
        ...
        creator_has_more_than_threshold_percent: creator_holdings.quantity > max_token_threshold,
        top_holder_more_than_threshold_percent: top_holder.quantity > max_token_threshold,
    };
